...
class ProjectsController extends BaseController
{
    ...
    {	
		...
		$sequences = $this->getDoctrine()->getRepository('ZeegaDataBundle:Sequence')->findBy(array("project" => $id, "enabled" => true));
		$frames = $this->getDoctrine()->getRepository('ZeegaDataBundle:Frame')->findBy(array("project" => $id, "enabled" => true));
		$layers = $this->getDoctrine()->getRepository('ZeegaDataBundle:Layer')->findBy(array("project" => $id, "enabled" => true));
