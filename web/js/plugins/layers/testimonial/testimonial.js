(function(Layer){
	...
	Layer.Testimonial = Layer.Model.extend({

		layerType : 'Testimonial',
		displayCitation : true,
		linkable : true,
		
		defaultAttributes: {
			'title' :'Testimonial Layer',
			'content' : 'Text',
			'left' :0,
			'top' :25, 
			'color' : '#ffffff',
	...
	Layer.Views.Controls.Testimonial = Layer.Views.Controls.extend({
	...
	Layer.Views.Visual.Testimonial = Layer.Views.Visual.extend({
