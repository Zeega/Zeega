...
Popcorn.player( "flashvideo", {
  ...
  media.waiting =true;
    ...
    flashvideoObject.sendToFlash("load", src+','+options.cue_in);
      ...
      swfobject.embedSWF("//alpha.zeega.org/MediaPlayer.swf", container.id, "100%", "100%", "9.0.0", false, flashvars, params, attributes);
